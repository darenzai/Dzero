 ...
 * RedisProperties
 */
@ConfigurationProperties(prefix = DZeroRedisProperties.PREFIX)
public class DZeroRedisProperties {
    ...
    public DZeroRedisProperties setRedisQueue(boolean redisQueue) {
    ...
    public DZeroRedisProperties setIntervals(int intervals) {
