...
public class RedisQueueHelper {
    ...
    private final com.hzero.core.redis.RedisHelper redisHelper;
    private final com.hzero.core.redis.DZeroRedisProperties properties;

    public RedisQueueHelper(com.hzero.core.redis.RedisHelper redisHelper, com.hzero.core.redis.DZeroRedisProperties redisProperties) {
