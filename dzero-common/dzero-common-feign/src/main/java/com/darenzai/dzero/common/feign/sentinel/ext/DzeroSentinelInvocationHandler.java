...
import com.darenzai.dzero.common.feign.annotation.FeignRetry;
import feign.Feign;
 ...
 */
@Slf4j
public class DzeroSentinelInvocationHandler implements InvocationHandler {
	...
	DzeroSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			DzeroSentinelInvocationHandler other = (DzeroSentinelInvocationHandler) obj;
