package com.darenzai.dzero.common.core.constant;
 ...
 */
public final class DZeroCacheKey {

    /**
     * 用户
     */
    public static final String USER = DZeroService.Iam.CODE + ":user";
    ...
    public interface Lov {
         ...
         * 值集缓存路径
         */
        String LOV_KEY = DZeroService.Platform.CODE + ":lov";
