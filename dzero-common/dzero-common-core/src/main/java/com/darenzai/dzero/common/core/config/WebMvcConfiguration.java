...
package com.darenzai.dzero.common.core.config;

import cn.hutool.core.date.DatePattern;
import com.darenzai.dzero.common.core.jackson.DzeroJavaTimeModule;
...
public class WebMvcConfiguration implements WebMvcConfigurer {
	...
	/**
	 * 增加GET请求参数中时间类型转换 {@link DzeroJavaTimeModule}
	 * <ul>
