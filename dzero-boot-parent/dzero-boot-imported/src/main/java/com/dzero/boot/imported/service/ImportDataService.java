...
public interface ImportDataService {
     ...
     */
    String uploadData(String templateCode, String param, MultipartFile file) throws IOException;
     ...
     * @return 批次号
     */
    String uploadData(String templateCode, String param, InputStream inputStream, String filename);
     ...
     * @return 上传数据
     */
    Page<ImportData> pageData(String templateCode, String batch, Integer sheetIndex, DataStatus status, Page page);
