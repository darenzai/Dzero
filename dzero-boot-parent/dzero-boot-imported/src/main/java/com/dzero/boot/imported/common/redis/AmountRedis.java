package com.dzero.boot.imported.common.redis;

import com.darenzai.dzero.common.core.constant.DZeroService;
...
public class AmountRedis {
    ...
    private static String getCountKey(String batch) {
        return DZeroService.Import.CODE + ":count:" + batch;
    }

    private static String getReadyKey(String batch) {
        return DZeroService.Import.CODE + ":ready:" + batch;
    }
